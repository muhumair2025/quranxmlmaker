...
<div class="max-w-4xl mx-auto">
    ...
    <div class="mb-8">
        ...
        <h1 class="text-3xl font-bold text-gray-900 mt-2 mb-2">Create Category</h1>
        <p class="text-gray-600">Add a new main category to your content</p>
    </div>
                ...
                <div class="bg-gradient-to-r from-blue-50 to-purple-50 border border-blue-200 rounded-lg p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="text" id="name_english" name="name_english" value="{{ old('name_english') }}" required
                        ...
                        <div>
                            ...
                            <input type="text" id="name_urdu" name="name_urdu" value="{{ old('name_urdu') }}" required dir="rtl"
                        ...
                        <div>
                            ...
                            <input type="text" id="name_arabic" name="name_arabic" value="{{ old('name_arabic') }}" required dir="rtl"
                        ...
                        <div>
                            ...
                            <input type="text" id="name_pashto" name="name_pashto" value="{{ old('name_pashto') }}" required dir="rtl"
                    ...
                    @if($icons->count() > 0)
                        <div class="grid grid-cols-4 sm:grid-cols-6 md:grid-cols-8 lg:grid-cols-10 gap-3">
                            ...
                            <label class="relative cursor-pointer group">
                                <input type="radio" name="icon_library_id" value="{{ $icon->id }}" class="hidden icon-radio" {{ old('icon_library_id') == $icon->id ? 'checked' : '' }}>
