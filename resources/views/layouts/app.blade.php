        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <div class="hidden md:flex items-center space-x-6">
                    @auth
                        <a href="{{ route('content.index') }}" class="text-sm text-gray-700 hover:text-green-600 transition-colors font-medium flex items-center">
            ...
            <div id="mobile-menu" class="hidden md:hidden pb-4 border-t border-gray-200 mt-2">
                <div class="flex flex-col space-y-3 pt-4">
                    @auth
                        <a href="{{ route('content.index') }}" class="text-sm text-gray-700 hover:text-green-600 transition-colors font-medium flex items-center px-2 py-2">
