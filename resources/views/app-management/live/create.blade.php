...
<div class="max-w-3xl">
    ...
    <div class="mb-8">
        ...
        <h1 class="text-3xl font-bold text-gray-900 mb-2">Add Live Video</h1>
        <p class="text-gray-600">Add a YouTube live stream for your mobile app</p>
    </div>

    <!-- Form -->
    <form action="{{ route('app.live.store') }}" method="POST" class="bg-white rounded-lg border border-gray-200 p-8">
        @csrf
        ...
        <div class="mb-6">
            ...
            <div class="grid grid-cols-3 gap-4">
                <label class="relative flex items-center p-4 border-2 border-gray-300 rounded-lg cursor-pointer hover:border-red-500 transition-colors">
                    <input type="radio" name="status" value="upcoming" class="hidden status-radio" required {{ old('status', 'upcoming') === 'upcoming' ? 'checked' : '' }}>
                ...
                <label class="relative flex items-center p-4 border-2 border-gray-300 rounded-lg cursor-pointer hover:border-red-500 transition-colors">
                    <input type="radio" name="status" value="live" class="hidden status-radio" required {{ old('status') === 'live' ? 'checked' : '' }}>
                    <div class="flex flex-col items-center w-full">
                ...
                <label class="relative flex items-center p-4 border-2 border-gray-300 rounded-lg cursor-pointer hover:border-red-500 transition-colors">
                    <input type="radio" name="status" value="ended" class="hidden status-radio" required {{ old('status') === 'ended' ? 'checked' : '' }}>
                    <div class="flex flex-col items-center w-full">
